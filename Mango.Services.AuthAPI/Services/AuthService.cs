...
public class AuthService(IJwtTokenGenerator _jwtTokenGenerator,AppDbContext _dbContext, UserManager<ApplicationUser> _userManager, RoleManager<IdentityRole> _roleManager) : IAuthService
{
